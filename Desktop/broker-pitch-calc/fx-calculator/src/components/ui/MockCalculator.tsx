    ...
    <Card className="bg-white/10 backdrop-blur-md border-white/20 rounded-xl shadow-xl max-w-lg mx-auto" style={{ color: '#C7B3FF' }}>
      <CardHeader className="text-center pb-3">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <CardTitle className="text-base font-bold bg-gradient-to-r from-purple-300 to-blue-300 bg-clip-text text-transparent">
            FX Pitch Calculator
          </CardTitle>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-3">
        <div className="space-y-1">
          ...
          <div className="bg-white/10 border-white/30 text-purple-100 p-1.5 rounded-lg text-sm">
            GBP/USD
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-1">
            ...
            <div className="bg-white/5 border-green-500/30 text-purple-100 p-1.5 rounded font-mono text-sm">
              1.3550
            </div>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-purple-200">Competitor</Label>
            <div className="bg-white/5 border-red-500/30 text-purple-100 p-1.5 rounded font-mono text-sm">
              1.3575
            </div>
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className="bg-white/5 border-white/30 text-purple-100 p-1.5 rounded-lg text-sm">
            {today}
          </div>
        </div>
        ...
        <Button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white text-sm py-1.5">
